...
@implementation GLView
{
    ...
    GLuint textureSamplerUniform_AMC;           // For Texture Uniform
    GLuint keyPressedUniform_AMC;               // For Key Pressed Uniform
...
-(int)initialize
{
    ...
    smiley_texture_AMC = [self loadGLTexture:"smiley.bmp"];
