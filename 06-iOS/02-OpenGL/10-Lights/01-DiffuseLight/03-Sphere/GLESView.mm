...
GLfloat lightDiffuse_AMC[] = { 1.0f, 1.0f, 1.0f, 1.0f }; // White Diffuse Light
GLfloat materialDiffuse_AMC[] = { 0.5f, 0.5f, 0.5f, 1.0f };
GLfloat lightPosition_AMC[] = { 0.0f, 0.0f, 2.0f, 1.0f }; // It is like light getting from out of the satge
...
-(void)display
{
    ...
    modelViewMatrix_AMC = translationMatrix_AMC;
