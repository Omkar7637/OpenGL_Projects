...
-(void)display
{
    ...
    translationMatrix_SAG = vmath::translate(0.0f, 0.0f, -6.0f);
    ...
    mat4 modelViewProjectionMatrix_SAG = perspectiveProjectionMatrix_SAG * modelViewMatrix_SAG; // here order of multiplication is VVIMP.
