...
@implementation GLESView
{
    ...
    // Texture Variables
    GLuint texture_checkboard_SAG;
    GLubyte checkImage_SAG[CHECK_IMAGE_HIGHT][CHECK_IMAGE_WIDTH][4];
}
...
-(void)makeCheckImage
{
    ...
    int i_SAG, j_SAG, c_SAG;

    for (i_SAG = 0; i_SAG < CHECK_IMAGE_HIGHT; i_SAG++)
    {
        for (j_SAG = 0; j_SAG < CHECK_IMAGE_WIDTH; j_SAG++)
        {
            c_SAG = (((i_SAG & 0x8) == 0) ^ ((j_SAG & 0x8) == 0)) * 255;

            checkImage_SAG[i_SAG][j_SAG][0] = (GLubyte)c_SAG;
            checkImage_SAG[i_SAG][j_SAG][1] = (GLubyte)c_SAG;
            checkImage_SAG[i_SAG][j_SAG][2] = (GLubyte)c_SAG;
            checkImage_SAG[i_SAG][j_SAG][3] = (GLubyte)255;
        }
    }
}
...
-(void)loadGLTexture
{
    ...
    glGenTextures(1, &texture_checkboard_SAG);
    glBindTexture(GL_TEXTURE_2D, texture_checkboard_SAG);
    glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, CHECK_IMAGE_WIDTH, CHECK_IMAGE_HIGHT, 0, GL_RGBA, GL_UNSIGNED_BYTE, (void*)checkImage_SAG);
...
{
    // ------------------------------------------- VARIABLE DECLARATIONS -----------------------------------------------------------------
    GLfloat square_positions_SAG[12];
    ...
    square_positions_SAG[0] = 0.0f;
    square_positions_SAG[1] = 1.0f;
    square_positions_SAG[2] = 0.0f;

    square_positions_SAG[3] = -2.0f;
    square_positions_SAG[4] = 1.0f;
    square_positions_SAG[5] = 0.0f;
    
    square_positions_SAG[6] = -2.0f;
    square_positions_SAG[7] = -1.0f;
    square_positions_SAG[8] = 0.0f;
    
    square_positions_SAG[9] = 0.0f;
    square_positions_SAG[10] = -1.0f;
    square_positions_SAG[11] = 0.0f;

    glBindBuffer(GL_ARRAY_BUFFER, vbo_position_SAG);
    glBufferData(GL_ARRAY_BUFFER, sizeof(square_positions_SAG), square_positions_SAG, GL_DYNAMIC_DRAW);
    glBindBuffer(GL_ARRAY_BUFFER, 0);
    ...
    square_positions_SAG[0] = 2.41421f;
    square_positions_SAG[1] = 1.0f;
    square_positions_SAG[2] = -1.41421f;

    square_positions_SAG[3] = 1.0f;
    square_positions_SAG[4] = 1.0f;
    square_positions_SAG[5] = 0.0f;

    square_positions_SAG[6] = 1.0f;
    square_positions_SAG[7] = -1.0f;
    square_positions_SAG[8] = 0.0f;

    square_positions_SAG[9] = 2.41421f;
    square_positions_SAG[10] = -1.0f;
    square_positions_SAG[11] = -1.41421f;
