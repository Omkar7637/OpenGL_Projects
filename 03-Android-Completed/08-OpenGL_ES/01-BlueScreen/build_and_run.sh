#!/bin/bash
# =============================================
# Android Project Build, Install, and Log Script (WSL + Windows ADB)
# =============================================
...
# -------------------------------
# Install APK using Windows ADB
# -------------------------------
WIN_ADB="/mnt/c/Users/Omkar/AppData/Local/Android/Sdk/platform-tools/adb.exe"

echo
echo "--- Installing APK on connected device ---"
"$WIN_ADB" devices | grep -q "device" 
if [ $? -ne 0 ]; then
    echo "No connected device found. Please connect your Android device to Windows."
    exit 1
fi

"$WIN_ADB" -d install -r "app/build/outputs/apk/debug/app-debug.apk"
if [ $? -ne 0 ]; then
