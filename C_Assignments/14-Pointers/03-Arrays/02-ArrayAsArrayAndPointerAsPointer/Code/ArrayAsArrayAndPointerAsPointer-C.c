...
int main(void)
{
    ...
    // code
    // ##### USING ARRAY NAME AS A ARRAY i.e : Value Of xth Element Of iArray : iarray[x] AND address Of xth Elents Of iarray : &iarray[x] #####
    printf("\n\n");
    printf("*** USING ARRAY NAME AS A ARRAY i.e : Value Of xth Elements Of iArray : iArray[x] AND Address Of xth Element Of iArray : &iArray[x] ***\n\n");
