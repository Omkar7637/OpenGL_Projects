...
int main(void)
{
    ...
    printf("8th Element Of Array 'iArrayOne[]' Or Element At 6th Index Of Array 'iArrayOne[]' = %d\n", iArrayOne[7]);
    ...
    printf("Piece=meal (User Input) Assigment And Display Of Elements to Array 'iArrayTwo[]' : \n\n");
