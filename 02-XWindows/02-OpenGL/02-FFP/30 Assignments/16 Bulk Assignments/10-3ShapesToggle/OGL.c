...
void hollowSquare()
{
	...
	GLfloat lineColor[] = { 1.0f, 1.0f, 0.0f };
	GLfloat lineVertex1[] = { 0.5f, 0.5f, 0.0f };
	GLfloat lineVertex2[] = { -0.5f, 0.5f, 0.0f };
	GLfloat lineVertex3[] = { -0.5f, -0.5f, 0.0f };
	GLfloat lineVertex4[] = { 0.5f, -0.5f, 0.0f };
	...
	drawLine(lineColor, lineColor, lineVertex3, lineVertex4, lineWidth);
	drawLine(lineColor, lineColor, lineVertex4, lineVertex1, lineWidth);
}
