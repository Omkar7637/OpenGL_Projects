...
GLfloat xTranslateTriangle = 2.4f;
GLfloat yTranslateTriangle = 1.0f;

GLfloat xTranslateCircle = 2.4f;
GLfloat yTranslateCircle = 1.0f;

//GLfloat xTranslateLine = 2.4f;
GLfloat yTranslateLine = 1.0f;
...
void display(void)
{
	...
	if (line)
	{
		glTranslatef(0.0f, yTranslateLine, 0.0f);
		drawVerticalLine();
	}
	...
	if (circle)
	{
		glTranslatef(xTranslateCircle, -yTranslateCircle - 0.05, 0.0f);
		glTranslatef(0.0f, -0.15f, 0.0f);
		glRotatef(angleTriangle, 0.0f, 1.0f, 0.0f);
		hollowCircle(0.0f, 0.0f, 0.3f);
	}
...
void drawVerticalLine()
{
	...
	GLfloat lineColor[] = { 1.0f, 0.8f, 0.05f };
	GLfloat lineVertex1[] = { 0.0f, 0.5f, 0.0f };
	GLfloat lineVertex2[] = { 0.0f, -0.5f, 0.0f };
...
void hollowTriangle()
{
	...
	GLfloat lineColor[] = { 1.0f, 0.8f, 0.05f };
	GLfloat lineVertex1[] = { 0.0f, 0.5f, 0.0f };
	GLfloat lineVertex2[] = { -0.5f, -0.5f, 0.0f };
	GLfloat lineVertex3[] = { 0.5f, -0.5f, 0.0f };

	drawLine(lineColor, lineColor, lineVertex1, lineVertex2, lineWidth);
	drawLine(lineColor, lineColor, lineVertex2, lineVertex3, lineWidth);
	drawLine(lineColor, lineColor, lineVertex3, lineVertex1, lineWidth);
}
...
{
    // code
	GLfloat spinningSpeed = 0.5f;
	GLfloat xTranslatingSpeed = 0.004f;
	GLfloat yTranslatingSpeed = 0.002f;

	// Angle Triangle
	angleTriangle = angleTriangle + spinningSpeed;
	...
	// Translate triangle
	xTranslateTriangle = xTranslateTriangle - xTranslatingSpeed;
	yTranslateTriangle = yTranslateTriangle - yTranslatingSpeed;

	if (xTranslateTriangle <= 0.0f && yTranslateTriangle <= 0.0f)
	{
		xTranslateTriangle = 0.0f;
		yTranslateTriangle = 0.0f;
		circle = True;
	}
	...
	if (circle)
	{
		xTranslateCircle = xTranslateCircle - xTranslatingSpeed;
		yTranslateCircle = yTranslateCircle - yTranslatingSpeed;

		if (xTranslateCircle <= 0.0f && yTranslateCircle <= 0.0f)
		{
			xTranslateCircle = 0.0f;
			yTranslateCircle = 0.0f;
			line = True;
		}
	}
	...
	if (line)
	{
		yTranslateLine = yTranslateLine - yTranslatingSpeed;
