...
int initialize(void)
{
	...
	perspectiveMatrix[10] = 0.0f;
	perspectiveMatrix[11] = 0.0f;

	// Column 4
	perspectiveMatrix[12] = 0.0f;
	perspectiveMatrix[13] = 0.0f;
	perspectiveMatrix[14] = 0.0f;
...
void resize(int width, int height)
{
	...
	GLfloat n = 0.1f;
	GLfloat f = 100.0f;
	GLfloat t = n *  tan((45.0 / 2.0));
	//GLfloat t = n * tan((45.0 / 2.0) * (PI / 180));

	GLfloat b = -t;
	GLfloat r = t * ((GLfloat)width / (GLfloat)height);
	GLfloat l = -r;

	// Declare matrix - Perspective
	// Column 1
	perspectiveMatrix[0] = t / ((GLfloat)width / (GLfloat)height);
	//perspectiveMatrix[0] = (2 * n) / (r - l);
	perspectiveMatrix[1] = 0.0f;
	perspectiveMatrix[2] = 0.0f;
	perspectiveMatrix[3] = 0.0f;
	...
	perspectiveMatrix[8] = 0.0f;
	perspectiveMatrix[9] = 0.0f;
	perspectiveMatrix[10] = (100.0f + 0.1f)/ (100.0f - 0.1f);
	perspectiveMatrix[11] = -1.0f;

	// Column 4
	perspectiveMatrix[12] = 0.0f;
	perspectiveMatrix[13] = 0.0f;
	perspectiveMatrix[14] = (2 * 100.0f * 0.1f) / (100.0f - 0.1f);
	perspectiveMatrix[15] = 0.0f;
...
void display(void)
{
    ...
    // Translate triangle backwords by Z-axiz
