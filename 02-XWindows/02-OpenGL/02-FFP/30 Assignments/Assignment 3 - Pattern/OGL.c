...
void pattern1(void)
{
	...
	for (float i = 0.0f; i < 0.8f; i = i + 0.2f)
	{
		for (float j = 0.0f; j < 0.8f; j = j + 0.2f)
		{
			glVertex3f(j, i, 0.0f);
		}
	}
...
void pattern2(void)
{
	...
	glLineWidth(3.0f);
	glBegin(GL_LINES);
	glVertex3f(0.0f, 0.2f, 0.0f);	glVertex3f(0.6f, 0.2f, 0.0f);
	glVertex3f(0.0f, 0.4f, 0.0f);	glVertex3f(0.6f, 0.4f, 0.0f);
	glVertex3f(0.0f, 0.6f, 0.0f);	glVertex3f(0.6f, 0.6f, 0.0f);
	glEnd();

	glBegin(GL_LINES);

	glVertex3f(0.0f, 0.6f, 0.0f);	glVertex3f(0.0f, 0.0f, 0.0f);
	glVertex3f(0.2f, 0.6f, 0.0f);	glVertex3f(0.2f, 0.0f, 0.0f);
	glVertex3f(0.4f, 0.6f, 0.0f);	glVertex3f(0.4f, 0.0f, 0.0f);
	glEnd();

	glBegin(GL_LINES);
	glVertex3f(0.2f, 0.6f, 0.0f);	glVertex3f(0.0f, 0.4f, 0.0f);
	glVertex3f(0.4f, 0.6f, 0.0f);	glVertex3f(0.0f, 0.2f, 0.0f);
	glVertex3f(0.6f, 0.6f, 0.0f);	glVertex3f(0.0f, 0.0f, 0.0f);
	glVertex3f(0.6f, 0.4f, 0.0f);	glVertex3f(0.2f, 0.0f, 0.0f);
	glVertex3f(0.6f, 0.2f, 0.0f);	glVertex3f(0.4f, 0.0f, 0.0f);
	glEnd();
}
...
void pattern3(void)
{
	...
	glLineWidth(3.0f);
	glBegin(GL_LINES);
	glVertex3f(0.0f, 0.0f, 0.0f);	glVertex3f(0.6f, 0.0f, 0.0f);
	glVertex3f(0.0f, 0.2f, 0.0f);	glVertex3f(0.6f, 0.2f, 0.0f);
	glVertex3f(0.0f, 0.4f, 0.0f);	glVertex3f(0.6f, 0.4f, 0.0f);
	glVertex3f(0.0f, 0.6f, 0.0f);	glVertex3f(0.6f, 0.6f, 0.0f);
	glEnd();
	...
	glVertex3f(0.2f, 0.6f, 0.0f);	glVertex3f(0.2f, 0.0f, 0.0f);
	glVertex3f(0.4f, 0.6f, 0.0f);	glVertex3f(0.4f, 0.0f, 0.0f);
	glVertex3f(0.6f, 0.6f, 0.0f);	glVertex3f(0.6f, 0.0f, 0.0f);
	glEnd();
}
...
void pattern5(void)
{
	...
	glVertex3f(0.0f, 0.0f, 0.0f);	glVertex3f(0.0f, 0.6f, 0.0f);
	...
	glBegin(GL_LINES);
	glVertex3f(0.0f, 0.6f, 0.0f);	glVertex3f(0.2f, 0.0f, 0.0f);
	glVertex3f(0.0f, 0.6f, 0.0f);	glVertex3f(0.4f, 0.0f, 0.0f);
	glVertex3f(0.0f, 0.6f, 0.0f);	glVertex3f(0.6f, 0.0f, 0.0f);
	glVertex3f(0.0f, 0.6f, 0.0f);	glVertex3f(0.6f, 0.2f, 0.0f);
	glVertex3f(0.0f, 0.6f, 0.0f);	glVertex3f(0.6f, 0.4f, 0.0f);
	glEnd();
}
