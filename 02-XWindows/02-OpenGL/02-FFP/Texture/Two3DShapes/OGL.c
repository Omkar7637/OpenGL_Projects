...
int main(void)
{
    ...
    XStoreName(gpDisplay, window, "RTR2024-150 Omkar Kashid | Texture - 2: 3D Shapes ");
...
int initialize(void)
{
    ...
    {
        fprintf(gpFile, "loadGLTexture() failed to create Stone image in Initialize\n");
        return (-6);
    }
    if (loadGLTexture(&texture_kundali, "VijayKundali.bmp") == False)
    {
        fprintf(gpFile, "loadGLTexture() failed to create Kundali image in Initialize\n");
        return (-6);
    }
...
void display(void)
{
	...
	// he OpenGL Mazya framebuffer madhlya color buffer la ja ani tyatli pratyek bit mi dilelya initialize madhlya glClearColor madhna clear kar | ani ata depth buffer la pn jaa tithe pn clear kar mi tula initialize madhe dilelya clear depth madhlya
	...
	//Front surface
	//Right top - quadrant 1
	glTexCoord2f(1.0f, 1.0f);
	glVertex3f(1.0f, 1.0f, 1.0f);
	//left top - quadrant 2
	glTexCoord2f(0.0f, 1.0f);
	glVertex3f(-1.0f, 1.0f, 1.0f);
	//left bottom - quadrant 3
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(-1.0f, -1.0f, 1.0f);
	//right bottom - quadrant 4
	glTexCoord2f(1.0f, 0.0f);
	glVertex3f(1.0f, -1.0f, 1.0f);

	//Right Face
	glTexCoord2f(1.0f, 1.0f);
	glVertex3f(1.0f, 1.0f, -1.0f);	// Right top - quadrant 1 is in backside
	glTexCoord2f(0.0f, 1.0f);
	glVertex3f(1.0f, 1.0f, 1.0f);	//left top - quadrant 2
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(1.0f, -1.0f, 1.0f);	//left bottom - quadrant 3
	glTexCoord2f(1.0f, 0.0f);
	glVertex3f(1.0f, -1.0f, -1.0f);	//right bottom - quadrant 4
	...
	glVertex3f(-1.0f, -1.0f, -1.0f);	//left bottom - quadrant 3
	glTexCoord2f(1.0f, 0.0f);
	glVertex3f(-1.0f, -1.0f, 1.0f);	//right bottom - quadrant

	//Top Face
	glTexCoord2f(1.0f, 1.0f);
	glVertex3f(1.0f, 1.0f, -1.0f);	// Right top becomes backside of lefttop or right side's right top
	glTexCoord2f(0.0f, 1.0f);
	glVertex3f(-1.0f, 1.0f, -1.0f);	//left top - quadrant 2
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(-1.0f, 1.0f, 1.0f);	//left bottom - quadrant 3
