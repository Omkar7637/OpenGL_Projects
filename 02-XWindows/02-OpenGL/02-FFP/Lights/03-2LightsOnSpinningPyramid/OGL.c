...
GLfloat lightDiffuse0[] = {1.0f, 0.0f, 0.0, 1.0f};
...
GLfloat lightDiffuse1[] = {0.0f, 0.0f, 1.0, 1.0f};
...
int main(void)
{
    ...
    XStoreName(gpDisplay, window, "RTR2024-150 Omkar Kashid | 2 Lights on Spinning Pyramid ");
