...
int main(void)
{
    ...
    XStoreName(gpDisplay, window, "RTR2024-150 Omkar Kashid | Solar System with Moon");
        ...
        while (XPending(gpDisplay))
        {
            ...
            case KeyPress:
                ...
                case 'q':
                    ...
                    break;
                case 'W':
                    moonRevolution = (moonRevolution + 3) % 360;
                    break;
                case 'w':
                    moonRevolution = (moonRevolution - 3) % 360;
                    break;
...
void display(void)
{
    ...
    gluSphere(quadric, 0.20f, 20, 20);
    glPopMatrix();
    glPushMatrix();
    glRotatef((GLfloat)moonRevolution, 0.0f, 1.0f, 0.0f);
