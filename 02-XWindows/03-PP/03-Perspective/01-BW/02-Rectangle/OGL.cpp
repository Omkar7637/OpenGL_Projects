...
int main(void)
{
    ...
    std::string combindStr = "Omkar Kashid | Xwindows : " + foldernameStr;
    const char* windowName = combindStr.c_str();

    XStoreName(gpDisplay, window, windowName);

    // XStoreName(gpDisplay, window, "Omkar Kashid | Xwindows_PP : Ortho_Triangle");
