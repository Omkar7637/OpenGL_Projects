// /home/pranav/My_Projects/02-OpenGL/Xwindows_PP/06-Texture/01-BW/01-Triangle/
...
int main(void)
{
    ...
    std::string combinedStr = "Pranav A. Shinde | Xwindows : " + foldernameStr;
...
int initialize(void)
{
    ...
    */
	...
	const GLfloat triangle_texCoord[] = {
		// front
		0.5, 1.0, // front-top
		0.0, 0.0, // front-left
		1.0, 0.0, // front-right
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(triangle_texCoord), triangle_texCoord, GL_STATIC_DRAW);
...
{
    // code
    angleTriangle += angleTriangleCnt;
