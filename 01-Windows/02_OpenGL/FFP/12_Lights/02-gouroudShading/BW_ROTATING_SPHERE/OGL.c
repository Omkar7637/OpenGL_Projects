...
GLfloat matrialDifuse[] = { 0.5f, 0.2f, 0.7f, 1.0f };
GLfloat matrialSpeculir[] = { 0.7f, 0.7f, 0.7f, 1.0f};
...
void display(void)
{
	...
	gluSphere(quadric, 0.1f, 5000, 5000);
...
static float t = 0.0f; // Time variable to gradually change light position
