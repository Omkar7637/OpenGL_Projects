...
int initialized(void)
{
	...
	frustomMatrix[0] = (2.0f * n) / (r - l);
	frustomMatrix[1] = 0.0f;
	frustomMatrix[2] = 0.0f;
	frustomMatrix[3] = 0.0f;
	frustomMatrix[4] = 0.0f;
	frustomMatrix[5] = (2.0f * n) / (t - b);
	frustomMatrix[6] = 0.0f;
	frustomMatrix[7] = 0.0f;
	frustomMatrix[8] = (r + l) / (r - l);
	frustomMatrix[9] = (t + b) / (t - b);
	frustomMatrix[10] = -(f + n) / (f - n);
	frustomMatrix[11] = -1.0f;
	frustomMatrix[12] = 0.0f;
	frustomMatrix[13] = 0.0f;
	frustomMatrix[14] = -(2.0f * f * n) / (f - n);
	frustomMatrix[15] = 0.0f;
...
void display(void)
{
	...
	glVertex3f(0.0f, 1.0f, 0.0f);							// size changed from 1.0f to 50.0f  
