...
// Vriables for lights
GLfloat lightAbiant[] = {0.5f, 0.5f, 0.5f, 1.0f};
GLfloat lightDefuse[] = {1.0f, 1.0f, 1.0f, 1.0f};
GLfloat lightPosition[] = {0.0f, 0.0f, 0.0f, 2.0f};
BOOL bLight = FALSE;
...
void display(void)
{
	...
	glBegin(GL_QUADS); // Tells OpenGL that we are drawing.
	...
	glEnd(); // Tells OpenGL that we have finished.
...
void update(void)
{
	...
	if (!gbFullScreen) {
		switch (viewPortSelector) {
		case 1:
			glViewport(-200, -100, (GLsizei)WIN_WIDTH, (GLsizei)WIN_HEIGHT);
			break;
		case 2:
			glViewport(200, -100, (GLsizei)WIN_WIDTH, (GLsizei)WIN_HEIGHT);
			break;
		...
		case 4:
			...
			break;
		case 5:
			glViewport(0, -100, (GLsizei)WIN_WIDTH, (GLsizei)WIN_HEIGHT);
			break;
		case 6:
			glViewport(0, 100, (GLsizei)WIN_WIDTH, (GLsizei)WIN_HEIGHT);
			break;
		case 7:
			glViewport(200, 0, (GLsizei)WIN_WIDTH, (GLsizei)WIN_HEIGHT);
			break;
		case 8:
			glViewport(-200, 0, (GLsizei)WIN_WIDTH, (GLsizei)WIN_HEIGHT);
			break;
		...
		case 1:
			...
			break;
		case 2:
			glViewport(w / 3, 0, (GLsizei)w / 2, (GLsizei)h / 2);
			break;
		case 3:
			glViewport(w / 3, h / 3, (GLsizei)w / 2, (GLsizei)h / 2);
			break;
		case 4:
			glViewport(0, h / 3, (GLsizei)w / 2, (GLsizei)h / 2);
			break;
		case 5:
			glViewport(w / 7, 0, (GLsizei)w / 2, (GLsizei)h / 2);
			break;
		case 6:
			glViewport(w / 7, h / 3, (GLsizei)w / 2, (GLsizei)h / 2);
			break;
		case 7:
			glViewport(w / 3, h / 7, (GLsizei)w / 2, (GLsizei)h / 2);
			break;
		case 8:
			glViewport(0, h / 7, (GLsizei)w / 2, (GLsizei)h / 2);
			break;
		case 9:
			glViewport(w / 7, h / 7, (GLsizei)w / 2, (GLsizei)h / 2);
			break;
		default:
			glViewport(w / 7, h / 7, (GLsizei)w / 2, (GLsizei)h / 2);
			break;
