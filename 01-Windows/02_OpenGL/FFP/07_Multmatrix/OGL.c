...
int initialized(void)
{
	...
	// transltation matrix
	translatationMatrix[0] = 1.0f;
	translatationMatrix[1] = 0.0f;
	translatationMatrix[2] = 0.0f;
	translatationMatrix[3] = 0.0f;
	translatationMatrix[4] = 0.0f;
	translatationMatrix[5] = 1.0f;
	translatationMatrix[6] = 0.0f;
	translatationMatrix[7] = 0.0f;
	translatationMatrix[8] = 0.0f;
	translatationMatrix[9] = 0.0f;
	translatationMatrix[10] = 1.0f;
	translatationMatrix[11] = 0.0f;
	translatationMatrix[12] = 0.0f;
	translatationMatrix[13] = 0.0f;
	translatationMatrix[14] = -6.0f;
	translatationMatrix[15] = 1.0f;
...
void display(void)
{
	...
	// rotationMatrixZ[1] = cos(angle);
	// rotationMatrixZ[2] = sin(angle);
    ...
    // glTranslatef(2.5f, 0.0f, 0.0f); // Move pyramid right
