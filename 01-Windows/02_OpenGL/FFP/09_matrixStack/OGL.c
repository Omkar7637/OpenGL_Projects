...
void display(void)
{
	...
	// adjest the polls of spear of sun's
	...
	// after drwing spear we need to go back to the otignal to draw Earth hence restore the matrix
	glPopMatrix();

	// Code for earth
	// agon save this matrix to let'sus to come back agin
	glPushMatrix();

	// let the earth allow to revole around the sun
	glRotatef((GLfloat)year, 0.0f, 1.0f, 0.0f);

	// Keep Earth at some disteance from the sun
	glTranslatef(1.5f, 0.0f, 0.0f);
	
	// adjest the pols of spear of Earth
	glRotatef(90.0f, 1.0f, 0.0f, 0.0f);

	// now let the earth spin/rotate aroun it self
