...
void display(void)
{
	...
	glVertex3f(0.0f, 50.0f, 0.0f); // Places a vertex at the top.
	
	//left bottom
	//glColor3f(0.0f, 1.0f, 0.0f); // Sets color to Green.
	glVertex3f(-50.0f, -50.0f, 0.0f); // Places a vertex at the bottom-left.
	
	//right bottom
	// glColor3f(0.0f, 0.0f, 1.0f); // Sets color to Blue.
	glVertex3f(50.0f, -50.0f, 0.0f); //Places a vertex at the bottom-right.
