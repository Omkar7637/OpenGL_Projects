...
int initialized(void)
{
	...
	// COLOR
	glGenBuffers(1, &vbo_color_pyramid); // vertex Buffer Object
	...
	// COLOR
	glGenBuffers(1, &vbo_color_cube); // vertex Buffer Object
...
void display(void)
{
    ...
    mat4 rotationMatrix = vmath::rotate(anglepyramid, 0.0f, 1.0f, 0.0f); // Y-axis rotation

    modelViewMatrix = translationMatrix * rotationMatrix;
    modelViewProjectionMatrix = presepectiveProjectionMatrix * modelViewMatrix;

    // Send MVP matrix to vertex shader
    glUniformMatrix4fv(mvpMatrixUniform, 1, GL_FALSE, modelViewProjectionMatrix);

    // Bind and draw pyramid
    glBindVertexArray(vao_pyramid);
    ...
    mat4 scaleMatrix = vmath::scale(0.85f, 0.85f, 0.85f);
